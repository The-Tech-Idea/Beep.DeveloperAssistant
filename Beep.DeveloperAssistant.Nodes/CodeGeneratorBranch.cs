...
{
    [AddinAttribute(Caption = "Code Generator", misc = "Beep", FileType = "Beep", iconimage = "codegen.png", menu = "DEV", ObjectType = "Beep.DEV.GEN")]
    ...
    public class CodeGeneratorBranch : IBranch
    {
        ...
        [CommandAttribute(Caption = "Open",Hidden =false, iconimage = "ideopen.ico")]
